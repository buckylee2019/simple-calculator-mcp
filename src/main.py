...
mcp = FastMCP(
    ...
    instructions="""
    This MCP server provides simple calculator functions to perform operations on numbers.
    Available operations include addition, subtraction, multiplication, division, and more.
    
    The calculator supports basic arithmetic, trigonometric functions, logarithms, and more.
    All operations are performed with high precision and detailed results are provided.
    """,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Simple Calculator MCP Server')
    ...
    logger.info(f"Starting Simple Calculator MCP server on {args.host}:{args.port}")
